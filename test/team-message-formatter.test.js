...
test("identifica equipes pelas categorias atuais e futuras", () => {
  ...
  assert.equal(teamLabel({ code: "ATACADO", name: "Atacado", parent: { name: "Comercial" } }), "Comercial: Atacado");
  assert.equal(formatTeamMessage({ name: "Atacado", parent: { name: "Comercial" } }, "Olá"), "[*Comercial*: Atacado]\n\nOlá");
